...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xbad79;
...
const char     CRYPTONOTE_NAME[]                             = "badint3ntcoin";
...
const int      P2P_DEFAULT_PORT                              = 77666;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 78666;
